...

{
  ...
  Old_total_expense = Readmission_rate * Average_stay_cost * Patient_population
  #calculate the readmission expense before implimenting the Diabetes Management program
  
  New_readmission_expense = Average_stay_cost * (Readmitted - (True_Positives * Average_prog_readmi_perc_drop))
  #calculate expense of readmission AND of the Diabetes Management  program after implimenting the DM program

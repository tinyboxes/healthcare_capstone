...
dumvars2 = dumvars %>% select (-c('race', 'race_Other', 'gender', 'admission_type_id',
...
dumvars2 = dumvars2 %>% select(-c('admission_type_id_Trauma Center', 
                                  ...
                                  'medical_specialty_Pediatrics-Neurology', 'medical_specialty_Pediatrics-Pulmonology', 
                                  'medical_specialty_PhysicalMedicineandRehabilitation','medical_specialty_PhysicianNotFound', 'medical_specialty_Podiatry', 
                                  'medical_specialty_Psychiatry-Addictive', 'medical_specialty_Psychiatry-Child/Adolescent', 
                                  'medical_specialty_Psychology', 'medical_specialty_Radiology', 'medical_specialty_Rheumatology', 
...
write.csv(df_FINAL, file = "test_tim_12.1.csv")

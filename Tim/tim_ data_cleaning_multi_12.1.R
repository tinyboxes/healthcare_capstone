...
dumvars2 = dumvars %>% select (-c('race', 'race_Other', 'gender', 'gender_Unknown/Invalid', 'admission_type_id',
                                  ...
                                  'admission_source_id_Sick Baby', 'medical_specialty_NA', 'diag_1_0','diag_2_0',
                                  ...
                                  'change_No', 'diabetesMed_No','readmitted_NO', 'readmitted_>30'))
...
dumvars2 = dumvars2 %>% select(-c('admission_type_id_Trauma Center', 'admission_source_id_Extramural Birth',
                                  ...
                                  'medical_specialty_DCPTEAM', 'medical_specialty_Dentistry', 'medical_specialty_Dermatology', 
                                  ...
                                  'medical_specialty_Pediatrics-AllergyandImmunology', 'medical_specialty_Pediatrics-EmergencyMedicine', 'medical_specialty_Pediatrics-Endocrinology', 
                                  'medical_specialty_Pediatrics-Hematology-Oncology', 'medical_specialty_Pediatrics-InfectiousDiseases',
                                  ...
                                  'medical_specialty_Proctology','medical_specialty_Psychiatry-Addictive', 'medical_specialty_Psychiatry-Child/Adolescent', 
                                  'medical_specialty_Psychology', 'medical_specialty_Radiology', 'medical_specialty_Resident','medical_specialty_Rheumatology', 
                                  'medical_specialty_SportsMedicine', 'medical_specialty_Surgeon', 'medical_specialty_Surgery-Cardiovascular',
                                  'medical_specialty_Surgery-Colon&Rectal', 'medical_specialty_Surgery-Maxillofacial', 'medical_specialty_Surgery-Neuro',
                                  'medical_specialty_Surgery-Pediatric', 'medical_specialty_Surgery-PlasticwithinHeadandNeck', 'medical_specialty_Surgery-Thoracic', 
...
write.csv(df_FINAL, file = "train_multi_tim_12.1.csv")
